...
export default function Flow() {
  ...
  return (
      <>  
        ...
        <Grid item xs={12} style={{display:"flex",flexDirection:"row",justifyContent:"center"}} >
         <Typography variant="h1" >How do we provide you the ideal Candidates?</Typography>
        </Grid>
        </Grid>
        <div className={classes.step}>
        <Paper className={classes.paper} >
                <Typography variant="body2" > STEP 1 </Typography>
                <Typography variant="caption" color="primary" > Post Jobs in 30 Seconds </Typography>
            </Paper>    
  ...
  <Paper className={classes.paper1} >
      ...
      <Typography variant="caption" color="primary" >Connect with Colleges & Institutes</Typography>
  </Paper>  
  ...
  <Paper className={classes.paper2} >
                ...
                <Typography variant="caption" color="primary" >Choose from 1 Lac+ Active Candidates</Typography>
            </Paper>  
  ...
  <Paper className={classes.paper3} >
                ...
                <Typography variant="caption" color="primary" >Evaluate Skills</Typography>
            </Paper>  
  ...
  <Paper className={classes.paper4} >
                ...
                <Typography variant="caption" color="primary" >Shortlist with AI</Typography>
            </Paper>  
  ...
  <Paper className={classes.paper5} >
                ...
                <Typography variant="caption" color="primary" >Hire in 24 Hours</Typography>
                
            </Paper>      
    </div>
    <Grid container spacing={3}>
        <Grid item xs={12} style={{display:"flex",flexDirection:"row",justifyContent:"center",marginTop:"50px"}} >
        <CustomButton
        onClick={() => {
      ...
      ><Typography variant="body2" color="inherit">Post a Job New</Typography>
      </CustomButton>
        </Grid>
        </Grid>
