      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
          <div style={{marginTop:"70px"}}>
            <Typography variant="h2" color="initial">Are You Looking For</Typography>
            <br/>
            ...
            <Chip size="small" label="Work from home jobs" color="primary" />
             ...
             <br/>
             <Button variant="text" color="primary" endIcon={<ArrowForwardIcon/>} >Check out all the New Opportunities</Button>
          </div>
        </Grid>
        <Grid item xs={12} sm={6}>
