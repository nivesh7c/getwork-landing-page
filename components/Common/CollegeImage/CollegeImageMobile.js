...
export default function CollegeImageMobile() {
            ...
            <Grid container spacing={3} className={classes.imgs}>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co1.png" height="100%" width="90%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co2.jpg" height="100%" width="100%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co3.png" height="100%" width="80%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co4.png" height="100%" width="100%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co8.png" height="100%" width="100%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co5.png" height="100%" width="90%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co6.png" height="100%" width="80%" />
                </Paper>
              </Grid>
              <Grid item xs={6} md={2}>
                <Paper className={classes.paper}>
                  <Image src="/college/co7.jpg" height="100%" width="90%" />
                </Paper>
              </Grid>
            </Grid>
          </Paper>
