      ...
      <Paper className={classes.paper}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={10} sm={3} md={11} style={{ paddingLeft: "10px" }}>
            <Typography variant="h6">Register your Students</Typography>
          </Grid>
          <Grid item xs={2} sm={3} md={1}>
            <Typography variant="h6" color="primary">
              {" "}
          ...
          <Grid item xs={10} sm={3} md={11} style={{ paddingLeft: "10px" }}>
            <Typography variant="h6">Invite Companies</Typography>
          </Grid>
          <Grid item xs={2} sm={3} md={1}>
            <Typography variant="h6" color="primary">
              {" "}
          ...
          <Grid item xs={10} sm={3} md={11} style={{ paddingLeft: "10px" }}>
            <Typography variant="h6">Track Placement</Typography>
          </Grid>
          <Grid item xs={2} sm={3} md={1}>
            <Typography variant="h6" color="primary">
              {" "}
          ...
          <Grid item xs={10} sm={3} md={11} style={{ paddingLeft: "10px" }}>
            <Typography variant="h6">Rank Up Your College</Typography>
